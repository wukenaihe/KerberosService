...
public interface StClientProcessor {
	 ...
	 * 组装ST请求信息
	 * 
	 * @param firstResponseWrapper 第一次请求获取的信息
	 * @param clientName 客户端名字
	 * @param serverName 请求服务名称（务必确保正确）
	 * @param ip 请求服务器IP地址
	 * @param lifeTime ST的有效时间
	 * @return
	 * @throws KerberosException
	 */
	SecondRequest getSecondRequest(FirstResponseWrapper firstResponseWrapper,String clientName,String serverName,String ip,long lifeTime) throws KerberosException;
